                            ...
                            <div className="card-body p-md-5">
                                <div className="row justify-content-center">
                                    ...
                                    <div className="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <p className="text-center h3 fw-bold reg-padding-p">Sign up</p>
                                        ...
                                        <div className="mx-1 mx-md-5">
                                            ...
                                            <form id="register-form" method="POST">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fas fa-user fa-lg me-3 fa-fw btn-ic"></i>
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fas fa-envelope fa-lg me-3 fa-fw btn-ic"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fas fa-lock fa-lg me-3 fa-fw btn-ic"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                ...
                                                <div className="d-flex flex-row align-items-center mb-2">
                                                    <i className="fas fa-key fa-lg me-3 fa-fw btn-ic"></i>
                                                    <div className="form-outline flex-fill mb-0">
                                                ...
                                                <div className="d-flex justify-content-center mx-4 mb-3 mb-lg-2 p-3">
                                                    <button type="button" className="btn btn-primary btn-lg">Register</button>
                                                </div>
                                                <div className="text-center text-lg-start mt-0 pt-0">
