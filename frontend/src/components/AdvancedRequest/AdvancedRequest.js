import styles from './AdvancedRequest.module.css';

// Make a request without a registration. Ask for a registration with an alert!!!
            ...
            <div className={styles.mainContainerStyle}>
                <div className={styles.rowContainer}>
                    <div className={styles.textContainer}>
                        <h1 className={styles.firstTitle}>Make Your First Request</h1>
                        ...
                        <div className={styles.fillContainerDesign}>
                            <form className={styles.formDesign}>
                                <div className={styles.eachGapDesign}>
                                    <input type="text" className={styles.formStyle} placeholder="First Name" required="required" />
                                </div>
                                <div className={styles.eachGapDesign}>
                                    <input type="text" className={styles.formStyle} placeholder="Last Name" required="required" />
                                </div>
                                <div className={styles.eachGapDesign}>
